...
<body>
  ...
  <main>
    {% block content %}
    <h2 class="main__title">Especifique o número de aparelhos que consomem eletricidade:</h2>
    <ul class="list" id="list">
      <li class="list__item">
        <a href="/result/{{ size }}/{{ lights }}/3">
          <img class="item__img" src="/static/img/battery.svg" alt="battery">
          <span>3-5 aparelhos</span></a>
      </li>

      <li class="list__item">
        <a href="/result/{{ size }}/{{ lights }}/6">
          <img class="item__img" src="/static/img/battery.svg" alt="battery">
          <span>6-8 aparelhos</span></a>
      </li>

      <li class="list__item">
        <a href="/result/{{ size }}/{{ lights }}/10">
          <img class="item__img" src="/static/img/battery.svg" alt="battery">
          <span>10 ou mais</span></a>
      </li>
    </ul>
    {% endblock %}
  </main>
